...
def test_document_upload_and_listing_are_exposed_in_openapi() -> None:
    ...
    assert upload["responses"]["413"]["description"] == "Content Too Large"
    assert upload["responses"]["422"]["description"] == "Unprocessable Content"
    ...
    assert listing["responses"]["422"]["description"] == "Unprocessable Content"
