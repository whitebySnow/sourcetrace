...
class Settings(BaseSettings):
    ...
    llm_prompt_version: str = "grounded-answer-v5"
    ...
    llm_citation_repair_prompt_version: str = "citation-repair-v6"
    ...
    answer_workflow_version: str = "langgraph-bounded-multi-query-v4"
