...
提交 `86715f4` 在 dense top-8 初始候选不变的前提下，为命中候选补入同一文档版本、同一页内
有限相邻的 chunk，并保留原始候选的分数来源。这用于处理答案证据被同页 chunk 边界拆开的
...
`diagnose-citations` 的 v2 契约。输入报告绑定提交 `beed1e6726843b70e257d77827e81c71f338d692` 与 SHA-256
